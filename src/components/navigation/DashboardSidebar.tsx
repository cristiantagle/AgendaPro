...
const navItems: NavItem[] = [
    ...
    {
        href: "/empresa#trabajadores-tabla",
        label: "Trabajadores",
        icon: "👥",
        roles: ["company_admin"],
    },
    ...
    return (
        <>
            <button
                ...
                className="lg:hidden fixed left-4 top-[88px] z-30 rounded-2xl border border-white/20 bg-white/10 p-3 text-white shadow-lg backdrop-blur"
            >
                ☰
            </button>
            <aside
                className={`${
                    isOpen ? "translate-x-0 opacity-100" : "-translate-x-96 opacity-0 lg:opacity-100 lg:translate-x-0"
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="lg:hidden rounded-xl border border-white/15 bg-white/10 px-2 py-1 text-xs text-white/70"
                    >
                        ✕
                    </button>
                </div>
